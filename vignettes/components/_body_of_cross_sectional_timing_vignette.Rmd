...
response.] and simulated below has the following advantages.
...
For clarity, we demonstrate with the results from sampling one `r actor` one three times.
...
caption <- "Example of three rows of data from MTS."
three_samples_df %>%
